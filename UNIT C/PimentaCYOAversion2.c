...
int main() 
 {
     ...
     if (response == "a"){ // if they choose to go upstairs
         ...
         // their answer for question 2A
            if (response == "g"){
                printf("You have managed to escape! However, you also have to end up selling the house and can't afford another, so you're now homeless. Good luck!\n"); //ENDING
            }
            else if (response == "h"){
                printf("You're actually so bad at trying to punch the ghost that she's shocked, and ends up falling over into the toilet bowl because she's laughing so hard and completely forgets her plans to kill you.\nYou end up becoming best friends (after you recover from your humiliation).\n"); //ENDING
            } 
        }  
             ...
             if (response == "i"){
                ...
                printf ("You can't kill a ghost with physical means! Shouldn't you know this? You die.\n");
            }
        }
    }
         ...
         if (response == "e"){
             ...
             if (response == "k"){
                ...
                printf("The green goldfish is your soulmate! However, the ghost finds you watching YouTube, and after sitting next to you and waiting for you to finish, she politely snaps your neck. She's kinda passive aggressive...sorry.\n"); //ENDING
             }
         }
             ...
             if (response == "m"){
                ...
                printf("The ghost turns out to just be looking for something to eat in the fridge- honestly, same. You sit down with her for dinner and have a lengthy conversation about taxes and Harry Styles.\n"); //ENDING
            }
        }
    }
    
    else{
        printf("NO! YOU ARE PUNISHED FOR ENTERING AN INVALID LETTER. YOUR FAMILY IS CURSED FOR ETERNITY. YOU WILL NEVER SEE THE LIGHT OF DAY AGAIN.\n");
    }
