/********
   Exercise 29 pg 104 cheng book part 2. write a program to simulate the flipping of a coin 10,000 times and print the simulation result similar to the one shown below
   PimentaCoinflip2.c
   Jenna Pimenta
   C Programming *******/
#include <stdio.h>
...
main ()
{
    ...
    for (flipcount = 1; flipcount <= 100000; flipcount++) {
